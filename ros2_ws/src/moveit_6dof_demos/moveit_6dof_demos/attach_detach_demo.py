...
def main():
    ...
    attached_collision_pub = scene_node.create_publisher(
    ...
    while (
        ...
        or attached_collision_pub.get_subscription_count() == 0
    ):
